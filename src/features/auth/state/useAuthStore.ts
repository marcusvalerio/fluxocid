...
export const useAuthStore = create<AuthState>((set) => ({
  ...
  async logout() { try { await apiFetch('/api/auth/logout', { method: 'POST' }) } catch { /* best effort */ } activateLocalRepository(); set({ status: 'unauthenticated', user: null, error: null }) },
